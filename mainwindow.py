...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.word_lineEdit = QtWidgets.QLineEdit(Form)
        ...
        self.sentence_textEdit = QtWidgets.QTextEdit(Form)
        self.sentence_textEdit.setObjectName("sentence_textEdit")
        self.horizontalLayout_2.addWidget(self.sentence_textEdit)
        ...
        self.textBrowser_meaning = QtWidgets.QTextBrowser(Form)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "句子"))
